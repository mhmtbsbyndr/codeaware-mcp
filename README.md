...
> **v2.1.1** — 17 tools · 10 languages · persistent memory · git intelligence · smart refactoring · test coverage · live dashboard · hook profiles · governance capture · session persistence · compaction hints
